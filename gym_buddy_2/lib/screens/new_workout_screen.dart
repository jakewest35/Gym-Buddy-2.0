...
import 'package:gym_buddy_2/models/exercise_model.dart';
              ...
              content: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration:
                        const InputDecoration(hintText: "Weight used in lbs."),
                    keyboardType:
                  ...
                  TextFormField(
                    ...
                    decoration:
                        const InputDecoration(hintText: "Number of sets"),
                    keyboardType:
                  ...
                  TextFormField(
                    ...
                    decoration:
                        const InputDecoration(hintText: "Number of reps"),
                    keyboardType:
                        const TextInputType.numberWithOptions(decimal: false),
                  ),
                ],
            ...
            ActionButton(
                ...
                onPressed: () {
                  ...
                  showDialog(
                    context: context,
                    builder: (context) => AlertDialog(
                      title: const Text("Cleared workout log!"),
                      actions: [
                        MaterialButton(
                          child: const Text("OK"),
                          onPressed: () {
